...
<svelte:head>
	<title>Srushti Jagtap- Privacy policy</title>
</svelte:head>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Srushti Jagtap.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p><strong>Country</strong> refers to: USA or India</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Srushti Jagtap, accessible from
